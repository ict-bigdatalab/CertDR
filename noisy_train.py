...
from dataset_utils import (output_modes, processors)
from modeling import Ranking_BERT_Train
from marcodoc.dataset import MSMARCONoisyDocDataset, get_collate_function
...
def main():
    ...
    # Other parameters
    parser.add_argument("--msmarco_dir", type=str, default="/data/msmarco_doc")
