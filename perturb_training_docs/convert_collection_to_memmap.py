...
if __name__ == "__main__":
    ...
    parser.add_argument("--tokenized_collection", type=str, 
        default="data/msmarco-doc/collection_memmap/tokenized_perturb_collection")
    parser.add_argument("--output_dir", type=str, default="data/msmarco-doc/collection_memmap/perturbed_0.9/")
    parser.add_argument("--dataset_type", type=str, default="document_ranking")
    args = parser.parse_args()

    if not os.path.exists(args.output_dir):
        os.makedirs(args.output_dir)
    if (args.dataset_type == 'document_ranking') or (args.dataset_type == 'passage_ranking'):
